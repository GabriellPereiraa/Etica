        ...
        <div class="main-content container-fluid">
            ...
            <div class="col-md-12">
                <blockquote class="blockquoteEad">
                    ...
                    <footer class="blockquote-footer">– (PLATÃO, 2005, p. 63.)</footer>
                </blockquote>
            </div>
            <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <blockquote class="blockquoteEad">
                                        ...
                                        <footer class="blockquote-footer">(BECCARIA, 1764, p.183) –</footer>
                                    </blockquote>
                                </div>
                                <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <blockquote class="blockquoteEad">
                                        ...
                                        <footer class="blockquote-footer">– (VASQUEZ, 2001, p. 283.)</footer>
                                    </blockquote>
                                </div>
                                <br>
                                ...
                                <div class="col-md-12">
                                    <blockquote class="blockquoteEad">
                                        <p class="mb-0">“A benevolência é a satisfação com a felicidade (bemestar) dos outros; a beneficência, porém, é a máxima de fazer a felicidade dos outros o próprio fim, e o dever a este correspondente consiste em ser o sujeito constrangido por sua razão a adorar esta máxima como uma lei universal.”</p>
                                        <footer class="blockquote-footer">(KANT, 2008, p. 296.) –</footer>
                                    </blockquote>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <blockquote class="blockquoteEad">
                                        ...
                                        <footer class="blockquote-footer">(KANT, 2004, p.31) –</footer>
                                    </blockquote>
                                </div>
                                <br>
                                ...
                                <div class="col-md-12">
                                    <blockquote class="blockquoteEad">
                                        ...
                                        <footer class="blockquote-footer">(KANT, 2004, p. 183.) –</footer>
                                    </blockquote>
                                </div>
