        ...
        <div class="main-content container-fluid">
            <div class="page-title">
                ...
                <h2 class="font-bold" style="color:#008445">
                    ...
                    <p class="Texto">
                        <i class="fas fa-bullseye CorLaranja"></i> Apresentar uma sumária conceituação de ética e moral, bem como alguns sistemas éticos e seus teóricos ao longo da história (períodos clássico grego, moderno e contemporâneo).
                    </p>
