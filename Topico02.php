        ...
        <div class="main-content container-fluid">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col col-lg-8 center borderAzul" style="background-color:#286ce6;">
                ...
                <div class="row justify-content-center">
                    <div class="col-4 borderAzul center">
                        <p class="Texto">
                            ÉTICA
                        </p>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col col-lg-8 center borderAzul" style="background-color:#286ce6;">
                        <p class="Texto gridAzul" style="color:white;">
                ...
                <div class="row">
                    <div class="col-2 center border" style="background-color:#286ce6;">
                        <p class="Texto" style="color:white;">
                            Exemplo
                        </p>
